...
Once your `todo-app-landing-refactor` worktree has served it's purpose, you should remove it to keep your workspace clean and save space.
...
git worktree remove todo-app-landing-refactor
```
